...
var keyList = [][2]string{
	...
	{"p", "the finder: open, start, or make a project"},
	...
	{"s", "shell"},
	{"a", "agent"},
	{"A", "continue a conversation at rest in the place"},
	{",", "the next kind of agent"},
	{"r", "run a dead entry again in place · run the plan"},
	{"x · X", "preview a kill · of the tree"},
	{"i", "look at the row: what it is, runs, holds and has shown"},
	...
	{"^spc A", "continue a conversation at rest in this place"},
	{"^spc ,", "the next kind of agent"},
	{"^spc i", "look at this buffer's process"},
